...
# fileadd = driver.find_element(
#     By.XPATH, "//input[@type = 'file' and @name = 'chatfile']").send_keys('C:/Users/VIRNECT/qa1.png')
# fileadd = driver.find_element(browsebutton).send_Keys(
#     'C:\\Users\\VIRNECT\\qa1.png')
...
# 첫번째 점찍기
# pyautogui.click(x=1036, y=783, clicks=1, interval=0.2)
# # 3초 대기
# time.sleep(5)
# # 두번째 점찍기
# pyautogui.click(x=1182, y=765, clicks=1, interval=0.2)
# # 3초 대기
# time.sleep(5)
# # 세번째 점찍기
# pyautogui.click(x=1311, y=762, clicks=1, interval=0.2)
# # 3초 대기
# time.sleep(5)

# [되돌리기] 버튼 3번 클릭하기(점 지우기)
# sharingimagerevert = driver.find_element(
#     By.XPATH, "//*[@class = 'main-body drawing']/div[@class = 'drawing-tools tools']/div[@class = 'tooltip'][3]/button[@class = 'tool']")
# for i in range(3):
#     sharingimagerevert.click()
#     time.sleep(3)

#[재실행] 버튼 3번 클릭하기(다시 점 살리기)
sharingimageReexecution = driver.find_element(
    By.XPATH, "//*[@class = 'main-body drawing']/div[@class = 'drawing-tools tools']/div[@class = 'tooltip'][4]/button[@class = 'tool']")
for i in range(3):
    sharingimageReexecution.click()
    time.sleep(3)
...
# fileadd = driver.find_element(
#     By.name, "//input[@name = 'chatfile']").element.sendKeys("C:/Users/VIRNECT/abc.png")
