...
def start():
    ...
    # formselect = WebDriverWait(driver, 5).until(
    #     EC.presence_of_element_located((By.XPATH, "//*[@id = 'statsSelectElement']"))
    # )
    # formselect.click()
    ...
    # api_2 = WebDriverWait(driver, 5).until(
